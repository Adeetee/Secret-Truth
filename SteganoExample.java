...
public class SteganoExample extends JFrame implements ActionListener
{
    Container con;
...
setVisible(true);
    ...
    f4.setMnemonic(KeyEvent.VK_A);f4.addActionListener(this);
        file.addSeparator();
...
*/	
    ...
    h1.setMnemonic(KeyEvent.VK_S);h1.addActionListener(this);
	help.add(h2=new JMenuItem("About...",new 	ImageIcon("images/information.gif")));
    h2.setMnemonic(KeyEvent.VK_A);h2.addActionListener(this);
	mb.add(help);
     	f2.setEnabled(false);
	f3.setEnabled(false);
	f4.setEnabled(false);
...
public void actionPerformed(ActionEvent e)
  ...
  public static void main(String arg[])
  {
	...
	SteganoExample yf = new SteganoExample();
